...
const TaxonomyNode = ({ 
    ...
    return (
        <div className="ml-3 border-l border-slate-200 pl-2">
            <div className="flex items-center py-1 rounded text-sm select-none group">
                
                {/* 1. ARROW CLICK: Always Toggle Expansion */}
                <div 
                ...
                {/* 2. LABEL CLICK: Context Aware (Select vs Expand) */}
                <div 
                    className={`flex items-center flex-1 cursor-pointer hover:bg-slate-100 px-1 rounded ${
                        isSelectionMode ? 'hover:text-blue-600 hover:font-semibold' : 'text-slate-700'
                    }`}
            ...
            {expanded && (
                <div>
                    {/* ... Children & Units rendering (unchanged) ... */}
